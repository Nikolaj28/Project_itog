...
class Main(tk.Frame):   # Класс главного окна
    ...
    def init_main(self): # Хранение и инициализация графических объектов(кнопки таблицы заголовки)
        ...
        self.add_img = tk.PhotoImage(file='C:/Users/Колян/Desktop/Питон/4 модуль/проект_итоговый/img/add.png')
        ...
        self.update_img = tk.PhotoImage(file='C:/Users/Колян/Desktop/Питон/4 модуль/проект_итоговый/img/update.png') # добавляем кнопу на редактирование
        btn_edit_dialog = tk.Button(toolbar, bg='#d7d8e0', bd=0, image=self.update_img, command=self.open_update_dialog)
        btn_edit_dialog.pack(side=tk.LEFT)

        self.delete_img = tk.PhotoImage(file='C:/Users/Колян/Desktop/Питон/4 модуль/проект_итоговый/img/delete.png')# Добавляем кнопу на удаление
        btn_delete = tk.Button(toolbar, bg='#d7d8e0', bd=0, image=self.delete_img, command=self.delete_record)
        btn_delete.pack(side=tk.LEFT)

        self.search_img = tk.PhotoImage(file='C:/Users/Колян/Desktop/Питон/4 модуль/проект_итоговый/img/search.png') #Добавляем кнопку на поиск
        btn_search = tk.Button(toolbar, bg='#d7d8e0', bd=0, image = self.search_img, command=self.open_search_dialog)
        btn_search.pack(side=tk.LEFT)

        self.refresh_img = tk.PhotoImage(file='C:/Users/Колян/Desktop/Питон/4 модуль/проект_итоговый/img/refresh.png') #добавляем кнопу на возвращение в исходное состояния после поиска
